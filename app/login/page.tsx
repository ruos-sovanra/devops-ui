...
const getFeatureFlag = async (flagName: string): Promise<boolean> => {
    ...
    return flagName === 'enable-google-login'
}
...
export default function LoginPage() {
    ...
    useEffect(() => {
        const checkGoogleLoginFlag = async () => {
            const isEnabled = await getFeatureFlag('enable-google-login')
            setIsGoogleLoginEnabled(isEnabled)
        }
                ...
                <div className="grid w-full gap-6 rounded-xl bg-white md:grid-cols-2 md:gap-12 lg:gap-16">
                    ...
                    <div className="hidden rounded-2xl bg-purple-500 p-6 md:block">
                        <div className="relative h-full w-full">
                            ...
                            {/*    <h2 className="text-2xl font-bold">Manage your task in a easy and more efficient way with Tasky...</h2>*/}
